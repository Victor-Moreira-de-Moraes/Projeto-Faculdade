...
'Apagar Transações': 'Apagar Transações',
...
'Data de transação': 'Data de transação',
...
'Editar Transações': 'Editar Transações',
...
'Nome da transação': 'Nome da transação',
'not in': 'not in',
'Nova Transação': 'Nova Transação',
'Nova Transações': 'Nova Transações',
